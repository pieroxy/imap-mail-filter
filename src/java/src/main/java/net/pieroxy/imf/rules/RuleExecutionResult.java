...
public record RuleExecutionResult(boolean ruleApplied, boolean keepProcessing, boolean learnedRulesExecuted) {
  ...
  public static final RuleExecutionResult NOT_APPLIED = new RuleExecutionResult(false, true, false);

  public static RuleExecutionResult applied(boolean keepProcessing) {
    return new RuleExecutionResult(true, keepProcessing, false);
  }
}
