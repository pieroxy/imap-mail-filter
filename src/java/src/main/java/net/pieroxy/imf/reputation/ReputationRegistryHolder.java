 ...
 * no other way to hand it to them. Unlike {@code SubjectClassifierContext} (a ThreadLocal, one
 * value per account/thread), a single registry serves the whole process: set once by
